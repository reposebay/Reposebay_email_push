...
@section('page-title')
    {{ __('Manage Beneficiary') }}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
    <li class="breadcrumb-item">{{ __('Beneficiary') }}</li>
@endsection

@section('action-button')
    @can('Create Payee')
        <a href="#" data-url="{{ route('payees.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Beneficiary') }}"
                                        ...
                                        @can('Edit Payee')
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    ...
                                                    data-title="{{ __('Edit Beneficiary') }}"
