...
@section('action-button')
    ...
    @can('Create Interview Schedule')
        <a href="#" data-url="{{ route('job.on.board.create', 0) }}" data-ajax-popup="true"
            data-title="{{ __('Create New Onboarding') }}" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Onboarding') }}</li>
@endsection
                                        ...
                                        {!! Form::close() !!} --}}
                                            ...
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    ...
                                                    data-ajax-popup="true" data-title="{{ __('Edit Onboarding') }}"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="{{ __('Edit') }}">
