            ...
            <div class="card-body">
                ...
                <h5 class="h4">
                    <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                        ...
                        <div>
                            <a href="{{ !empty($jobApplication->profile) ? asset('/storage/uploads/job/profile/' . $jobApplication->profile) : asset('/storage/uploads/avatar/avatar.png') }}" target="_blank" class="avatar rounded-circle avatar-sm">
                ...
                <div class="row">
                    <div class="col-auto">
                        ...
                        <div class="col-12 text-end">
                            ...
                            data-ajax-popup="true" class="btn-sm btn btn-primary" data-title="{{ __('OnBoard Applicant') }}"
                             data-bs-original-title="{{ __('OnBoard Applicant') }}">
                             <i class="ti ti-plus "></i>{{ __('OnBoard Applicant') }}</a>
                        </div>
                    </div>
                 </div>   
            </div>
                    ...
                    <dd class="col-sm-9">
                        ...
                        @if (!empty($jobApplication->resume))
                            ...
                            <div class="action-btn bg-secondary ms-2">
                                <a class="mx-3 btn btn-sm align-items-center" href="{{ asset(Storage::url('uploads/job/resume')) . '/' . $jobApplication->resume }}" target="_blank"  >
