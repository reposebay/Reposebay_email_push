...
<head>
    ...
    <title>
        {{ !empty($companySettings['title_text']) ? $companySettings['title_text']->value : config('app.name', 'Reposebay HRAAS') }}
        - {{ __('Career') }}</title>
            ...
            <div class="container pt-5">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <h2 class="h1 mb-4">{{ __('Find Job Openings') }}</h2>
                        <p class="lead lh-180">{{ __('Find the right Job for you...') }}</p>
        ...
        <section class="slice slice-lg bg-section-secondary">
            ...
            <div class="container">
                <div class="mb-5 text-center">
                    <h3 class=" mt-4">{{ __('We help all sizes of businesses grow') }}</h3>
                ...
                <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                    <div class="col-md-6">
                        <div class="copyright text-sm font-weight-bold text-center text-md-left">
                            {{ !empty($companySettings['footer_text']) ? $companySettings['footer_text']->value : 'Reposebay HRAAS' }}
                        </div>
                    </div>
                    <div class="col-md-6">
