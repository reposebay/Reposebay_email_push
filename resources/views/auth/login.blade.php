    ...
    <div class="login-contain">
        <div class="login-inner-contain">
            ...
            <h5 class="copyright-text">
                {{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Reposebay HRAAS') }} {{ date('Y') }}
            </h5>
    ...
    <div class="row align-items-center text-start">
                ...
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="" id="form_data">
                    ...
                    <div>
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Your Email">
                            @error('email')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control @error('password') is-invalid @enderror" id="password" type="password" name="password" required autocomplete="current-password" placeholder="Enter Your Password">
                            @error('password')
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                <img src="{{ asset('assets/images/auth/Reposebaylogin.png') }}" alt="" class="img-fluid">
                <h3 class="text-white mb-4 mt-5"> {{ __('“Do more without stress on REPOSEBAY”') }}</h3>
                <p class="text-white"> {{__(' Technology is nothing. What is, important is that you have a faith in people - Steve Jobs')}}</p>
            </div>
        </div>
    </div>
</div>
