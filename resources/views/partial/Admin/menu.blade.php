        ...
        <div class="m-header main-logo">
            <a href="{{ route('home') }}" class="b-brand">
                ...
                <img src="{{ asset(Storage::url('uploads/logo/' . $company_logo)) }}" alt="{{ env('APP_NAME') }}"
                    ...
                    alt="{{ config('app.name', 'Reposebay HRAAS') }}" class="logo logo-lg">
        ...
        <div class="navbar-content">
            ...
            @endif
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                @can('Manage User')
                                    <li class="dash-item">
                                        <a class="dash-link"
                                            href="{{ route('user.index') }}">{{ __('Admins') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Role')
                                    <li class="dash-item">
                                ...
                                @can('Manage Employee Last Login')
                                    <li class="dash-item">
                                        <a class="dash-link"
                                            href="{{ route('lastlogin') }}">{{ __('Staff Last Login') }}</a>
                                    </li>
                                @endcan
                ...
                <li class="dash-item {{ (Request::route()->getName() == 'contract.index' || Request::route()->getName() == 'contract.show') ? 'active' : '' }}">
                    <a href="{{route('contract.index')}}" class="dash-link"><span class="dash-mtext">{{__('Company Contracts')}}</span></a>
                </li>
                @endcan
            ...
            <!--end-->
                ...
                <li
                        ...
                        <a href="#" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-users"></i></span><span
                                class="dash-mtext">{{ __('Staff Management') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                       ...
                       <ul class="dash-submenu ">
                          ...
                          @can('Manage Meeting')
                                   <li class="dash-item {{ Request::segment(1) == 'meeting' ? 'active' : '' }}">
                                       <a href="{{ route('meeting.index') }}" class="dash-link"><span
                ...
                @if (Gate::check('Manage Awards') || Gate::check('Manage Transfer') || Gate::check('Manage Resignation') || Gate::check('Manage Travels') || Gate::check('Manage Promotion') || Gate::check('Manage Complaint') || Gate::check('Manage Warning') || Gate::check('Manage Termination') || Gate::check('Manage Announcement') || Gate::check('Manage Holiday'))
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class=""><i
                                    class=""></i></span><span
                                class="dash-mtext">{{ __('Self Service') }}</span><span
                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
            ...
            @endif
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @endcan
                             @can('Manage Job')
                                <li class="dash-item {{ Request::segment(1) == 'job' ? 'active' : '-' }}">
                                    <a class="dash-link" href="{{ route('job.create') }}">{{ __('Create Job') }}</a>
                                </li>
                            @endcan
                            @can('Manage Job Application')
                            <li class="dash-item {{ (request()->is('job-application*') ? 'active' : '')}}">
                                <a class="dash-link" href="{{route('job-application.index')}}">{{__('Application')}}</a>
                            </li>
                            @endcan
                            @can('Manage Job Application')

                            <li class="dash-item {{ (request()->is('candidates-job-applications') ? 'active' : '')}}">
                                <a class="dash-link" href="{{route('job.application.candidate')}}">{{__('Candidates')}}</a>
                            </li>
                            @endcan
                            ...
                            @can('Manage Job OnBoard')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('job.on.board') }}">{{ __('Onboarding') }}</a>
                                </li>
                            @endcan
                ...
                @if (Gate::check('Manage Indicator') || Gate::check('Manage Appraisal') || Gate::check('Manage Goal Tracking'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Staff Performance') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('Manage Indicator')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('indicator.index') }}">{{ __('Branch Performace Indicators') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Appraisal')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('appraisal.index') }}">{{ __('Performance Appraisal') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Goal Tracking')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('goaltracking.index') }}">{{ __('Company SMART Goals') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                @if (Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip'))
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Manage Payroll') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu ">
                            <li class="dash-item {{ Request::segment(1) == 'setsalary' ? 'active' : '-' }}">
                                <a class="dash-link"
                                    href="{{ route('setsalary.index') }}">{{ __('Set Salary Structure') }}</a>
                            </li>
                            <li class="dash-item">
                                <a class="dash-link"
                                    href="{{ route('payslip.index') }}">{{ __('Employee Payslip') }}</a>
                            </li>
                ...
                @if (Gate::check('Manage Account List') || Gate::check('Manage Payee') || Gate::check('Manage Payer') || Gate::check('Manage Deposit') || Gate::check('Manage Expense') || Gate::check('Manage Transfer Balance'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Company Finance') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            ...
                            @can('Manage Payee')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('payees.index') }}">{{ __('Beneficiary') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Payer')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('payer.index') }}">{{ __('Sender') }}</a>
                                </li>
                            @endcan
                ...
                @if (\Auth::user()->type == 'employee')
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-receipt"></i></span><span
                                class="dash-mtext">{{ __('Payslip') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            <li class="dash-item {{ Request::segment(1) == 'setsalary' ? 'active' : '-' }}">
                                <a class="dash-link"
                                    href="{{ route('setsalary.show', \Auth::user()->id) }}">{{ __('My Salary') }}</a>
                            </li>
                            <li class="dash-item">
                                <a class="dash-link"
                                    href="{{ route('payslip.index') }}">{{ __('My Payslip') }}</a>
                            </li>
                        </ul>
                    </li>
                @endif
                ...
                @if (\Auth::user()->type == 'employee')
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Manage Request') }}</span><span class="dash-arrow"><i
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item {{ Request::segment(1) == 'holiday' ? ' active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('holiday.calender') }}">{{ __('Holidays') }}</a>
                            </li>
                        </ul>
                    </li>
                @endif
                ...
                @if (Gate::check('Manage Trainer') || Gate::check('Manage Training'))
                    <li
                        ...
                        <a href="#!" class="dash-link "><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Learning') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('Manage Training')
                ...
                @if (Gate::check('Manage Trainer') || Gate::check('Manage Training'))
                    <li
                        ...
                        <a href="#!" class="dash-link "><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Communication') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            <!-- Event-->
                            @can('Manage Event')
                ...
                @can('Manage Ticket')
                    <li class="dash-item {{ Request::segment(1) == 'ticket' ? 'active' : '' }}">
                        <a href="{{ route('ticket.index') }}" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Feedback') }}</span></a>
                    </li>
                @endcan
                ...
                <li
                        ...
                        <a href="#" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-users"></i></span><span
                                class="dash-mtext">{{ __('Self Service') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                ...
                @if (\Auth::user()->type == 'super admin')
                <li class="dash-item">
                    <a href="{{ route('manage.email.language',[!empty($emailTemplate)?$emailTemplate ->id:0,\Auth::user()->lang]) }}" class="dash-link"><span
                ...
                @if ( Gate::check('Manage System Settings'))
                    <li class="dash-item ">
                        <a href="{{ route('settings.index') }}" class="dash-link"><span
                                ...
                                class="dash-mtext">{{ __('Company Setting') }}</span></a>
                     ...
                     <ul class="dash-submenu">
                         @if(Gate::check('Manage Company Settings'))
                             <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'company-setting') ? ' active' : '' }}">
                                 <a href="{{ route('settings.index') }}" class="dash-link">{{__('Company Settings')}}</a>
                             </li>
                         @endif
                         @if(Gate::check('Manage Plan'))
