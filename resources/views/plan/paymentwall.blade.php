...
<title>@if(Auth::user()->type == 'super admin')  {{config('app.name', 'Reposebay HRAAS')}} @else {{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Reposebay HRAAS')}} @endif</title>
