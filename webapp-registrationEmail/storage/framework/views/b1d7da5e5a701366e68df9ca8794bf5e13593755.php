...
unset($__errorArgs, $__bag); ?>" id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Enter Your Email">
...
unset($__errorArgs, $__bag); ?>" id="password" type="password" name="password" required autocomplete="current-password" placeholder="Enter Your Password">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                <img src="<?php echo e(asset('assets/images/auth/Reposebaylogin.png')); ?>" alt="" class="img-fluid">
                <h3 class="text-white mb-4 mt-5"> <?php echo e(__('“Do more without stress on REPOSEBAY”')); ?></h3>
                <p class="text-white"> <?php echo e(__(' Technology is nothing. What is, important is that you have a faith in people - Steve Jobs')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/auth/login.blade.php ENDPATH**/ ?>