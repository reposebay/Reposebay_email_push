<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Onboarding')); ?>
...
<?php $__env->startSection('action-button'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Interview Schedule')): ?>
        <a href="#" data-url="<?php echo e(route('job.on.board.create', 0)); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Onboarding')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Onboarding')); ?></li>
<?php $__env->stopSection(); ?>
                                        ...
                                        <span>
                                            ...
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    ...
                                                    data-ajax-popup="true" data-title="<?php echo e(__('Edit Onboarding')); ?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/jobApplication/onboard.blade.php ENDPATH**/ ?>