...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6 dob d-none">
            ...
            <?php echo Form::text('dob', old('dob'), ['class' => 'form-control d_week', 'autocomplete' => 'off']); ?>
        ...
        <div class="form-group col-md-12 letter d-none">
            ...
            <?php echo e(Form::textarea('cover_letter', null, ['class' => 'form-control'])); ?>
...
<?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/jobApplication/create.blade.php ENDPATH**/ ?>