                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="choose-files ">
                                            <label for="document">
                                                ...
                                                <input type="file" class="form-control file" name="profile" id="document">
                                            </label>
                                        </div>
                                        <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/user/profile.blade.php ENDPATH**/ ?>