    ...
    <?php if(\Auth::user()->type == 'super admin'): ?>
            ...
            <div class="col-xl-3">
                <div class="card  text-center">
                            ...
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="#!" class="dropdown-item bs-pass-para">
                                        <i class="ti ti-trash"></i><span class="ms-1"><?php if($user->delete_status == 0): ?><?php echo e(__('Delete')); ?> <?php else: ?> <?php echo e(__('Restore')); ?><?php endif; ?></span>
                                     </a>
                                    <?php echo Form::close(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <small>Last Login <?php echo e($user->last_login); ?></small>
                        <?php if(\Auth::user()->type == 'super admin'): ?>
                            <div class=" mb-0 mt-3">
                                <div class=" p-3">
                                    <div class="row">
                            ...
                            <p class="mt-2 mb-0">
                                <button class="btn btn-sm btn-neutral mt-3 font-weight-500">
                                    <a><h6><?php echo e(__('Joined Date : ')); ?> <?php echo e($user->created_at); ?> </h6></a>
                                </button>
                            </p>
                        <?php endif; ?>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <a href="#" class="btn-addnew-project my-4 " data-ajax-popup="true" data-url="<?php echo e(route('user.create')); ?>"
                data-title="<?php echo e(__('Create New Company')); ?>" data-bs-toggle="tooltip" title=""
                class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Create')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/user/index.blade.php ENDPATH**/ ?>