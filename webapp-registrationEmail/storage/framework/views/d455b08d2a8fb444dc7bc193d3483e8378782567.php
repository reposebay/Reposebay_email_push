                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $appraisals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appraisal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                     ...
                                     <?php if($appraisal->branches): ?>
                                      <td><?php echo e(!empty($appraisal->branches->name) ? $appraisal->branches->name : ''); ?></td>
                                     
                                     <?php else: ?>
                                     -
                                     <?php endif; ?>
                                    
                                  <?php if($appraisal->employees): ?>
                                  
                                    <td><?php echo e(!empty($appraisal->employees->department) ?  $appraisal->employees->department->name : '-'); ?>
                                    ...
                                    <td><?php echo e(!empty($appraisal->employees->designation) ?  $appraisal->employees->designation->name : '-'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/appraisal/index.blade.php ENDPATH**/ ?>