...
unset($__errorArgs, $__bag); ?>" 
                                                    ...
                                                    <img id="<?php echo e('blah'.$key); ?>" src="<?php echo e((isset($employeedoc[$document->id]) && !empty($employeedoc[$document->id])?asset(Storage::url('uploads/document')).'/'.$employeedoc[$document->id]:'')); ?>"  width="25%" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/employee/edit.blade.php ENDPATH**/ ?>