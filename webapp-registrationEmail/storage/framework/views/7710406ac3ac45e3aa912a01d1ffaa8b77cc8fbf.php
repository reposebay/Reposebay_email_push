...
<head>
    ...
    <title>
        <?php echo e(Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Reposebay HRAAS')); ?>
    ...
    <meta name="description" content="Reposebay is an HR Company that provides competent Human resource personnel for businesses and also offer HRAAS for companies of all sizes." />
    <meta name="keywords" content="HRAAS,reposebay,reposebay service,reposebay nigeria,reposebay Hr,reposebay company,reposebay lagos,reposebay company,reposebay startup" />
    <meta name="author" content="Customized by Truth" />
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-muted mb-4 ms-5">
                        Automaticaly take backup as per schedule
                    </p>
                    <div class="form-check form-switch">
        ...
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted"><?php echo e(__('Copyright')); ?> &copy;
                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Reposebay HRAAS')); ?>
...
<?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/layouts/admin.blade.php ENDPATH**/ ?>