...
<div class="modal-body">
    <div class="row">
        <div class="form-group">
            ...
            {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => __('Enter Feedback Subject')]) }}
        </div>
        @if (\Auth::user()->type != 'employee')
            <div class="form-group">
                {{ Form::label('employee_id', __('Feedback for Employee'), ['class' => 'col-form-label']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => __('Feedback Description'),'rows'=>'5']) }}
        </div>
    </div>
</div>
