...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ url('ticket') }}">{{ __('Feedback') }}</a></li>
    <li class="breadcrumb-item">{{ __('Feedback Reply') }}</li>
@endsection
...
@if (\Auth::user()->type == 'company' || $ticket->ticket_created == \Auth::user()->id)
        <a href="#" data-url="{{ URL::to('ticket/' . $ticket->id . '/edit') }}" data-ajax-popup="true"
            data-title="{{ __('Edit Feedback') }}" data-size="lg" data-bs-toggle="tooltip" title=""
            ...
            <div class="card">
                ...
                <li class="list-group-item border-0 d-flex align-items-center">
                    ...
                    <div class="form-group mb-0 form-send w-100">
                        {{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => __('Feedback Reply')]) }}
