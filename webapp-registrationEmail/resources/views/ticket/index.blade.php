...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Feedback') }}</li>
@endsection
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <h6 class="mb-3">{{ __('Total Feedback') }}</h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3">{{ __('Open Feedback') }}</h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3">{{ __('Hold Feedback') }}</h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3">{{ __('Close Feedback') }}</h6>
