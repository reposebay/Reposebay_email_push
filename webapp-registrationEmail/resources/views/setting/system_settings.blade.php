            ...
            <div class="col-xl-9">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class=" setting-card">
                                                        <div class="logo-content mt-4 setting-logo">
                                                            <img id="image" src="{{ asset(Storage::url('uploads/logo/logo-dark.png')) }}"
                                                                class="logo logo-sm"
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class=" setting-card">
                                                        <div class="logo-content mt-4  setting-logo">
                                                            <img id="image1" src="{{ asset(Storage::url('uploads/logo/logo-light.png')) }}"
                ...
                <div class="card" id="payment-setting">
                    <div class="card-header">
                        ...
                        <small
                            class="text-secondary font-weight-bold">{{ __('This detail will use for collect payment on plan from company . On plan company will find out pay now button based on your below configuration.') }}</small>
                    </div>
