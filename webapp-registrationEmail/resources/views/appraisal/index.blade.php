                        ...
                        <tbody>
                            ...
                            @foreach ($appraisals as $appraisal)
                                ...
                                <tr>
                                     ...
                                     @if($appraisal->branches)
                                      <td>{{ !empty($appraisal->branches->name) ? $appraisal->branches->name : '' }}</td>
                                     
                                     @else
                                     -
                                     @endif
                                    
                                  @if($appraisal->employees)
                                  
                                    <td>{{ !empty($appraisal->employees->department) ?  $appraisal->employees->department->name : '-'}}
                                    </td>
                                    @else
                                    -
                                    @endif
                                    ...
                                    <td>{{ !empty($appraisal->employees->designation) ?  $appraisal->employees->designation->name : '-' }}
                                    </td>
                                    <td>{{ !empty($appraisal->employees) ? $appraisal->employees->name : '-' }}</td>
                                    <td>
