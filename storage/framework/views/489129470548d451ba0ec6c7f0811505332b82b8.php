                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::text('start_date', old('start_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('end_date', __('End Date'), ['class' => 'col-form-label']); ?>

                            <?php echo Form::text('end_date', old('end_date'), ['class' => 'form-control d_week', 'autocomplete' => 'off']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/job/create.blade.php ENDPATH**/ ?>