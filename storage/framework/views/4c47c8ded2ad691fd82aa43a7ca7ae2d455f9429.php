                ...
                <div class="table-responsive">
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            <td><a href="#" class="action-item" data-url="<?php echo e(route('termination.description',$termination->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Desciption')); ?>" data-title="<?php echo e(__('Desciption')); ?>"><i class="fa fa-comment"></i></a>
                                    </td>
                                <td class="Action">
                                    <?php if(Gate::check('Edit Termination') || Gate::check('Delete Termination')): ?>
                                        <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/termination/index.blade.php ENDPATH**/ ?>