<?php $__env->startPush('scripts'); ?>
    ...
    <?php if(!empty($admin_payment_setting['is_paystack_enabled']) && isset($admin_payment_setting['is_paystack_enabled']) && $admin_payment_setting['is_paystack_enabled'] == 'on'): ?>
        <script>
    ...
    <?php if(!empty($admin_payment_setting['is_flutterwave_enabled']) && isset($admin_payment_setting['is_flutterwave_enabled']) && $admin_payment_setting['is_flutterwave_enabled'] == 'on'): ?>
        <script>
    ...
    <?php if(!empty($admin_payment_setting['is_razorpay_enabled']) && isset($admin_payment_setting['is_razorpay_enabled']) && $admin_payment_setting['is_razorpay_enabled'] == 'on'): ?>
        <script>
                                            ...
                                            <div class="border p-3 mb-3 rounded stripe-payment-div">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mt-3"><label
                                                            for="stripe_coupon"><?php echo e(__('Coupon')); ?></label></div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-footer text-end">
                                                ...
                                                <button class="btn btn-primary text-sm" type="submit">
                                                    ...
                                                    (<span
                                                        class="paypal-final-price"><?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?><?php echo e($plan->price); ?></span>)
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-footer text-end">
                                                ...
                                                <button class="btn btn-primary pay_with_paystack" type="button" id="pay_with_paystack">
                                                    ...
                                                    (<span
                                                        class="paystack-final-price"><?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?><?php echo e($plan->price); ?></span>)</button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/stripe.blade.php ENDPATH**/ ?>