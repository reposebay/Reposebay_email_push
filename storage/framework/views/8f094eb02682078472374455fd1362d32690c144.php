...
<head>
    ...
    <title>
        <?php echo e(!empty($companySettings['title_text']) ? $companySettings['title_text']->value : config('app.name', 'Reposebay HRAAS')); ?>
            ...
            <div class="container pt-5">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <h2 class="h1 mb-4"><?php echo e(__('Find Job Openings')); ?></h2>
                        <p class="lead lh-180"><?php echo e(__('Find the right Job for you...')); ?></p>
        ...
        <section class="slice slice-lg bg-section-secondary">
            ...
            <div class="container">
                <div class="mb-5 text-center">
                    <h3 class=" mt-4"><?php echo e(__('We help all sizes of businesses grow')); ?></h3>
                    <div class="fluid-paragraph mt-3">
                        <p class="lead lh-180 ">
                            <?php echo e(__('Aim higher.')); ?>
                ...
                <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                    <div class="col-md-6">
                        <div class="copyright text-sm font-weight-bold text-center text-md-left">
                            <?php echo e(!empty($companySettings['footer_text']) ? $companySettings['footer_text']->value : 'Reposebay HRAAS'); ?>
...
<?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/job/career.blade.php ENDPATH**/ ?>