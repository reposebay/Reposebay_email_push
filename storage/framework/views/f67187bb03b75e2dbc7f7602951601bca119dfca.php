        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <div class="btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                    ...
                    <label class="btn p-3" style="background-color: #eb8100 !important"><input type="radio" name="color" class="d-none" value="event-primary"></label>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/event/create.blade.php ENDPATH**/ ?>