                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if( $contract->status == 'Start'): ?>
                                                    <div class="badge bg-primary p-2 px-3 rounded status-badde3"><?php echo e(__('Start')); ?></div>
                                                <?php elseif( $contract->status== 'Close'): ?>
                                                    <div class="badge bg-danger p-2 px-3 rounded status-badde3"><?php echo e(__('Close')); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="Action">
                                                <span>
                                                    <?php if((\Auth::user()->type == 'company')&&($contract->status=='Start')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/contracts/index.blade.php ENDPATH**/ ?>