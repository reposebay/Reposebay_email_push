    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('payee_id', __('Beneficiary'), ['class' => 'col-form-label'])); ?>
...
<?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/expense/create.blade.php ENDPATH**/ ?>