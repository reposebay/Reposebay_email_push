<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Feedback')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Manage Feedback')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <h6 class="mb-3"><?php echo e(__('Total Feedback')); ?></h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3"><?php echo e(__('Open Feedback')); ?></h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3"><?php echo e(__('Hold Feedback')); ?></h6>
            ...
            <div class="col-lg-3 col-6">
                <div class="card ticket-card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-sm mt-4 mb-2"></p>
                        <h6 class="mb-3"><?php echo e(__('Close Feedback')); ?></h6>
    ...
    <div class="col-xxl-4">
        <div class="card">
            <div class="card-header">
                ...
                <h5><?php echo e(__('Feedback By Status')); ?></h5>
            </div>
            <div class="card-body">
    ...
    <script>
        (function() {
            var options = {
                ...
                colors: ["#3ec9d6", '#169aa6', '#fd7e14', '#ff3a6e'],
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/ticket/index.blade.php ENDPATH**/ ?>