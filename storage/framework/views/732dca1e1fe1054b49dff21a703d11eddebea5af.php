...
.messenger-favorites div.avatar {
    box-shadow: 0px 0px 0px 2px #eb8100 !important;
}
.messenger-listView-tabs a, .messenger-listView-tabs a:hover, .messenger-listView-tabs a:focus {
    color: linear-gradient(141.55deg, rgba(81, 69, 157, 0) 3.46%, rgba(255, 58, 110, 0.6) 99.86%), #eb8100 !important;
}
.m-header svg {
...
.messenger-listView-tabs a, .messenger-listView-tabs a:hover, .messenger-listView-tabs a:focus {
    color: linear-gradient(141.55deg, rgba(81, 69, 157, 0) 3.46%, #4ebbd3 99.86%), #000000 !important;
}
.m-header svg {
...
.messenger-favorites div.avatar {
    box-shadow: 0px 0px 0px 2px #169aa6 !important;
}
.messenger-listView-tabs a, .messenger-listView-tabs a:hover, .messenger-listView-tabs a:focus {
    color: linear-gradient(141.55deg, #169aa6 3.46%, #169aa6 99.86%), #169aa6 !important;
}
.m-header svg {
...
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repoxhpm/app.reposebay.com/resources/views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>